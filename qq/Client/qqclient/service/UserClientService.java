package qq.Client.qqclient.service;

import qq.Client.qqcommon.Message;
import qq.Client.qqcommon.MessageType;
import qq.Client.qqcommon.User;
...
public class UserClientService {
    ...
    public boolean checkUser(String userId, String pwd) {
        ...
        try {
            //连接到服务端，发送u对象
            socket = new Socket(InetAddress.getByName("192.168.10.3"), 9999);
